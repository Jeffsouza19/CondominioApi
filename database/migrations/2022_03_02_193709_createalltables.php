...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('unitvehicles', function(Blueprint $table){
            $table->id();
            $table->integer('id_unit');
            $table->string('title'); // nome do veiculo
            $table->string('color'); // cor do veiculo
            $table->string('plate'); // placa do veiculo
        });
        ...
        Schema::create('walls', function(Blueprint $table){
            $table->id();
            $table->string('title'); // nome do veiculo
            $table->string('body'); // cor do veiculo
            $table->date('datecreated'); // placa do veiculo
        });
